...
from typing import TYPE_CHECKING, Any, Dict, List as _TypingList, Optional, Union
...
class List(BaseModel):
    ...
    # --- Nested lists ---
    data: Optional[_TypingList[str]] = None
    externalReferences: Optional[_TypingList[ExternalReference]] = None
...
def list_to_df(items: _TypingList[List]) -> pd.DataFrame:
    """
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def filter(
        self,
        *,
        common_crop_names: Optional[_TypingList[str]] = None,
        program_dbids: Optional[_TypingList[str]] = None,
        program_names: Optional[_TypingList[str]] = None,
        ...
        list_dbids: Optional[_TypingList[str]] = None,
        list_names: Optional[_TypingList[str]] = None,
        list_owner_names: Optional[_TypingList[str]] = None,
        list_owner_person_dbids: Optional[_TypingList[str]] = None,
        list_sources: Optional[_TypingList[str]] = None,
